...
public class LavaforrisingBlock extends LiquidBlock {
	public LavaforrisingBlock() {
		super(() -> ProjectModFluids.LAVAFORRISING.get(), BlockBehaviour.Properties.of(Material.LAVA).strength(100f).noCollission().noLootTable());
	}
